...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE Comment(_IdComm INTEGER PRIMARY KEY AUTOINCREMENT, ValueComm TEXT, DateComm DATETIME, IdUser REFERENCES User(_IdUser), IdApp REFERENCES Application(_IdApp));");
        db.execSQL("CREATE TABLE Review(_IdRev INTEGER PRIMARY KEY AUTOINCREMENT, ValueRev TEXT, DescRev TEXT, DateRev DATETIME, VersionRev TEXT, IdUser REFERENCES User(_IdUser), IdApp REFERENCES Application(_IdApp));");
    }
